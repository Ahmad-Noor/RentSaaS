...
namespace RentSaaS.Infrastructure.Migrations
{
    ...
    [Migration("20250119212011_InitMigration")]
            ...
            modelBuilder.Entity("RentSaaS.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("f074c234-add4-4da3-ac4c-605ee50ecc3f"),
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "b325e789-54fe-49b5-b3ca-02bfbdb2f4dd",
                            CreatedAt = new DateTime(2025, 1, 19, 21, 20, 10, 348, DateTimeKind.Utc).AddTicks(7360),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            ...
                            OrganizationId = new Guid("00000000-0000-0000-0000-000000000001"),
                            PasswordHash = "AAzotWrdV5j4CgRYFCI/PFY41422056foz8CzzZ0F6jBm1BGkYAzKs17asj0WibAnA==",
