...
namespace RentSaaS.Infrastructure.Migrations
{
    ...
    [Migration("20250202193209_adding relation Expenses With Company")]
    partial class addingrelationExpensesWithCompany
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("RentSaaS.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("e4577c96-1c9f-4ff1-853a-305a7c617618"),
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "09d9b941-b049-4815-9cfc-77a43821dc55",
                            CreatedAt = new DateTime(2025, 2, 2, 19, 32, 7, 757, DateTimeKind.Utc).AddTicks(6588),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            ...
                            OrganizationId = new Guid("00000000-0000-0000-0000-000000000001"),
                            PasswordHash = "ALZSMuOWKqJSE2BZwS0VxBGvNzO2GpdRrjMqinBsJvdN+Sytn+AE+1K640mgnHB4Dw==",
