    ...
    public partial class AddedTenantTable : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LeaseTerms = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Lease_Organizations_OrganizationId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Lease_Tenants_TenantId",
                        column: x => x.TenantId,
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("aaaca442-19aa-4f20-b6b1-67fccff7f086"), 0, "b9dbf324-8e72-4abe-b2be-ca7c9ef87d02", new DateTime(2024, 12, 24, 19, 4, 17, 757, DateTimeKind.Utc).AddTicks(9387), new Guid("00000000-0000-0000-0000-000000000000"), null, null, "admin@rentsaas.com", false, "Admin", true, false, null, null, null, "Admin", false, null, null, null, null, new Guid("00000000-0000-0000-0000-000000000001"), "AAbvT12CHq/3rgzR7v1TxUcwhRapeA/TRbsOHjyZFisDWgOAB+MZHJbJvBl4gTGdfQ==", null, null, false, null, null, null, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, null, false, "admin" });
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DeleteData(
                table: "Identity.Users",
                keyColumn: "Id",
                keyValue: new Guid("aaaca442-19aa-4f20-b6b1-67fccff7f086"));
