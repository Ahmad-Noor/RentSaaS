...
namespace RentSaaS.Infrastructure.Migrations
{
    ...
    [Migration("20250206152325_AddRentapplicationTable")]
    partial class AddRentapplicationTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("RentSaaS.Domain.Entities.RentApplication", b =>
                {
                    ...
                    b.Property<bool>("Requestbackgroundcheck")
                        .HasColumnType("bit");

                    b.Property<bool>("Requestcreditreport")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("RentSaaS.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("b15ab41f-2209-43d0-9737-83bcb9f672d3"),
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "00fa109b-e560-4447-80d8-5c22bcb3f17a",
                            CreatedAt = new DateTime(2025, 2, 6, 15, 23, 24, 682, DateTimeKind.Utc).AddTicks(3787),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            ...
                            OrganizationId = new Guid("00000000-0000-0000-0000-000000000001"),
                            PasswordHash = "AAm2VxtGX5bbA83TXSwl3KV8XrLPnLfeZ9Gyk2h+73cWGTvhvUigr18btoUEP7mFpg==",
