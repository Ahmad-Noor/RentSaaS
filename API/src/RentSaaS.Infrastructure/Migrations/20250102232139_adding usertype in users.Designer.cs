...
namespace RentSaaS.Infrastructure.Migrations
{
    ...
    [Migration("20250102232139_adding usertype in users")]
    partial class addingusertypeinusers
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("RentSaaS.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("e21463d2-c0f7-4c4d-8811-ce8d0493401d"),
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "34040d0a-2783-45aa-88ec-a6afeb2b7ee7",
                            CreatedAt = new DateTime(2025, 1, 2, 23, 21, 37, 297, DateTimeKind.Utc).AddTicks(6353),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            ...
                            OrganizationId = new Guid("00000000-0000-0000-0000-000000000001"),
                            PasswordHash = "ANrj6D9sMvvj2nPHAZpl1afXDdyLzdCYGnaA9o5n4/hl5MabZMJmdIKrvFl0V62pww==",
