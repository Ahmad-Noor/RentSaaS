...
namespace RentSaaS.Infrastructure.Migrations
{
    ...
    [Migration("20250227094904_Update")]
            ...
            modelBuilder.Entity("RentSaaS.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("e837b6be-8578-4799-998a-c4e8186d1b6f"),
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "2cfe7248-840c-4873-849d-f073e16b9708",
                            CreatedAt = new DateTime(2025, 2, 27, 9, 49, 4, 150, DateTimeKind.Utc).AddTicks(8377),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            ...
                            OrganizationId = new Guid("00000000-0000-0000-0000-000000000001"),
                            PasswordHash = "AFPT60aWeu5fkuAs9JLXzf3AwpQjSVM3O3fYntFVlJjRHP2ETg9D4BbwFTJa83VNvw==",
