...
namespace RentSaaS.Infrastructure.Migrations
{
    ...
    [Migration("20250206101457_AdvertiseEdit")]
    partial class AdvertiseEdit
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("RentSaaS.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("0db6c4e1-7691-442e-bbc3-7e240d68dccd"),
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "7bdc28a8-8aad-486a-bcd2-ff4dd775c9e8",
                            CreatedAt = new DateTime(2025, 2, 6, 10, 14, 56, 404, DateTimeKind.Utc).AddTicks(6422),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            ...
                            OrganizationId = new Guid("00000000-0000-0000-0000-000000000001"),
                            PasswordHash = "AN+B2teB2GdmUklteJp9GONOekZqBY/Vy1ITLv2flb0NN/l1l31cROa7D5Y7zX/N3g==",
