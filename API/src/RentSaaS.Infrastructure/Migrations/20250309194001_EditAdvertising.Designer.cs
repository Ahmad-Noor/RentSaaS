...
namespace RentSaaS.Infrastructure.Migrations
{
    ...
    [Migration("20250309194001_EditAdvertising")]
    partial class EditAdvertising
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("RentSaaS.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("acd79ef2-9744-449e-9d94-610ed0feacf5"),
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "92614f78-f133-4028-aff4-9dfb5715fec8",
                            CreatedAt = new DateTime(2025, 3, 9, 19, 40, 0, 199, DateTimeKind.Utc).AddTicks(783),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            ...
                            OrganizationId = new Guid("00000000-0000-0000-0000-000000000001"),
                            PasswordHash = "AKbYLPi0YBrRfZIrc3IRnw+z4u0P+IkQVcSOegoZsXn8dp/uIJ40a06IC3lJteOcrQ==",
