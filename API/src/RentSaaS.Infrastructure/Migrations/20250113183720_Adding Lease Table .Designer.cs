...
namespace RentSaaS.Infrastructure.Migrations
{
    ...
    [Migration("20250113183720_Adding Lease Table ")]
    partial class AddingLeaseTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("RentSaaS.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("e1fb52ad-2c17-478d-9d91-33588034e9d0"),
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "8f948d3a-fb0e-4774-8597-353759554905",
                            CreatedAt = new DateTime(2025, 1, 13, 18, 37, 18, 519, DateTimeKind.Utc).AddTicks(3920),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            ...
                            OrganizationId = new Guid("00000000-0000-0000-0000-000000000001"),
                            PasswordHash = "AEoASkLKHpmCvV344/KrSZ/m4Ddq1XVePfZVMDxP0/1ZQnggDhso/dGmkBJ/phZ8vg==",
