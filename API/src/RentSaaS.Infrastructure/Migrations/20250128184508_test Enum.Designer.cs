...
namespace RentSaaS.Infrastructure.Migrations
{
    ...
    [Migration("20250128184508_test Enum")]
            ...
            modelBuilder.Entity("RentSaaS.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("327b078e-8a7a-4b82-b538-f9ccc1325c82"),
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "68dafa90-8d8a-4e38-bf20-01c99bf9c33c",
                            CreatedAt = new DateTime(2025, 1, 28, 18, 45, 7, 797, DateTimeKind.Utc).AddTicks(8377),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            ...
                            OrganizationId = new Guid("00000000-0000-0000-0000-000000000001"),
                            PasswordHash = "AOCL8Vfm2sdm0fIn5qcB3CZXHTK0XjO+p7dXkzM8EAPcSRsgaQSQffesNhko5b+EcQ==",
