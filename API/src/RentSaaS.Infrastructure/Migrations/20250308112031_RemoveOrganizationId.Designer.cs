...
namespace RentSaaS.Infrastructure.Migrations
{
    ...
    [Migration("20250308112031_RemoveOrganizationId")]
            ...
            modelBuilder.Entity("RentSaaS.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("1708c1af-6002-462f-9ca8-a67b15f4018b"),
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "60424c94-59ac-457a-90fd-3e39f5f135f0",
                            CreatedAt = new DateTime(2025, 3, 8, 11, 20, 29, 840, DateTimeKind.Utc).AddTicks(4738),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            ...
                            OrganizationId = new Guid("00000000-0000-0000-0000-000000000001"),
                            PasswordHash = "AMRCsj/BtGexoteclrjTSwz39W6hXGQFz8czSpzxEuUhZjHyn7tvwOuINKV2htiw1Q==",
